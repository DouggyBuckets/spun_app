...
router.get("/", requireAuth, async (req, res) => {
    ...
    const result = await db.query(
        ...
        SELECT 'rating' AS activity_type, r.user_id, u.username, u.display_name,
            ...
            r.score AS score, NULL::text AS body, r.created_at
        FROM ratings r
        ...
        SELECT 'review' AS activity_type, rv.user_id, u.username, u.display_name,
            ...
            COALESCE(al.external_id, so.external_id) AS spotify_id,
            songAlbum.external_id AS album_spotify_id,
            NULL::smallint AS score, rv.body AS body, rv.created_at
        FROM reviews rv
        ...
        SELECT 'like' AS activity_type, l.user_id, u.username, u.display_name,
            ...
            COALESCE(al.external_id, so.external_id) AS spotify_id,
            songAlbum.external_id AS album_spotify_id,
            NULL::smallint AS score, NULL::text AS body, l.created_at
        FROM likes l
        ...
        SELECT 'spin' AS activity_type, sp.user_id, u.username, u.display_name,
            ...
            COALESCE(al.external_id, so.external_id) AS spotify_id,
            songAlbum.external_id AS album_spotify_id,
            NULL::smallint AS score, NULL::text AS body, sp.created_at
        FROM spins sp
        ...
        SELECT 'follow' AS activity_type, f.follower_id AS user_id, u.username, u.display_name,
            ...
            followee.username AS entity_name,
            NULL::varchar AS spotify_id, NULL::varchar AS album_spotify_id,
            NULL::smallint AS score, NULL::text AS body, f.created_at
        FROM follows f
